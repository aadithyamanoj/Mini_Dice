...
import dice_pkg::*;
    ...
    block_commit_table #(
        ...
        .clk_i(clk),
        .rst_i(rst),
        .insert_valid_i(insert_valid),
        .insert_e_block_id_i(insert_e_block_id),
        .insert_pending_reads_i(insert_pending_reads),
        .insert_pending_writes_i(insert_pending_writes),
        .update_valid_i(update_valid),
        .update_e_block_id_i(update_e_block_id),
        .update_is_write_i(update_is_write),
        .update_reduce_count_i(update_reduce_count),
        .pop_valid_o(pop_valid),
        .pop_e_block_id_o(pop_e_block_id),
    ...
    initial begin
        ...
        $display("EBLOCK_ID_WIDTH=%0d", DICE_EBLOCK_ID_WIDTH);
        $display("========================================\n");
    ...
    task test_pop_ready_flow_control();
        ...
        repeat(5) @(negedge clk);
        if (pop_valid && hw_cta_pending) begin
