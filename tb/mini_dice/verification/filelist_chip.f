// ============================================================================
// filelist_chip.f — full chip_top UVM filelist
//
// Adds to filelist.f's mini_dice_top stack:
//   * chip_top.sv (pad ring + bsg_link_wrapper + internal reset sequencer)
//   * BaseJump bsg_link DDR + IDDR/ODDR phys (real link, not flit-direct)
//   * chip_stubs.sv (behavioral models for TSMC IO pad cells)
//   * tb_chip.sv (replaces tb_top.sv as top)
//
// Usage:
//   vcs -sverilog -full64 -timescale=1ns/1ps -ntb_opts uvm -f filelist_chip.f \
//       -top tb_chip $DICE_HOME/tb/cgra_core/dice_core/dpi_dice_core_runtime.cpp
//
// Env vars: DICE_HOME, BSG_HOME (same as filelist.f).
// ============================================================================
...
// chip_top + pad ring (uses TSMC IO cells stubbed below)
${DICE_HOME}/rtl/chip_top.sv

// ============================================================================
// TB-only: behavioral stubs for TSMC IO pad cells (chip_stubs.sv)
// + UVM env
// ============================================================================
${DICE_HOME}/tb/mini_dice/verification/chip_stubs.sv
${DICE_HOME}/tb/mini_dice/verification/mini_dice_chip_vif.sv
${DICE_HOME}/tb/mini_dice/verification/mini_dice_chip_pkg.sv
${DICE_HOME}/tb/mini_dice/verification/tb_chip.sv
