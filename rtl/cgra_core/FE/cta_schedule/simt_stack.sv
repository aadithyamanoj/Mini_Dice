...
(
    ...
    output logic [$clog2(SIMT_STACK_DEPTH):0] stack_depth_o,
    output logic [DICE_ADDR_WIDTH-1:0] error_pc_o
);
...
`endif
  ...
  assign stack_overflow_o = push_i && stack_full_o;
  assign stack_depth_o    = stack_ptr_q;
  assign error_pc_o       = push_next_pc_i;
