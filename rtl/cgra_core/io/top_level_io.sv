module top_level_io
  #(parameter int flit_width_p         = 16
   ...
   ,parameter int rx_link_fifo_els_p   = 16
   ,parameter int rx_aw_desc_fifo_els_p = 4
   ,parameter int rx_ar_desc_fifo_els_p = 4
   ,parameter int rx_w_len_fifo_els_p  = 8
   ,parameter int rx_w_data_fifo_els_p = 16
   ,parameter int rx_r_len_fifo_els_p  = 8
   ,parameter int rx_r_data_fifo_els_p = 16
   ,parameter int rx_b_resp_fifo_els_p = 8
   ,parameter int tx_link_fifo_els_p   = 16
   ,parameter int tx_aw_desc_fifo_els_p = 4
   ,parameter int tx_ar_desc_fifo_els_p = 4
   ,parameter int tx_w_len_fifo_els_p  = 8
   ,parameter int tx_w_data_fifo_els_p = 16
   ,parameter int tx_r_len_fifo_els_p  = 8
   ,parameter int tx_r_data_fifo_els_p = 16
   ,parameter int tx_b_resp_fifo_els_p = 8
   ,parameter int tx_pkt_order_fifo_els_p = 16
   )
