...
(
    ...
    constant_scoreboard #(.NUM_CONSTANT_REGS(`DICE_CR_NUM)) const_sb (
        ...
        .wb_const_bitmap(ld_dest_regs_bitmap[(`DICE_GPR_NUM + `DICE_CR_NUM - 1):`DICE_GPR_NUM]),
        .wb_valid(wb_valid && |ld_dest_regs_bitmap[(`DICE_GPR_NUM + `DICE_CR_NUM - 1):`DICE_GPR_NUM]),
