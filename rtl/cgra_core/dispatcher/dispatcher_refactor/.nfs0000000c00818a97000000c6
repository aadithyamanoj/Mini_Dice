...
(
    ...
    assign gpr_bitmap   = latched_input_regs[`DICE_GPR_NUM-1:0];
    assign const_bitmap = latched_input_regs[(`DICE_GPR_NUM+`DICE_CR_NUM)-1:`DICE_GPR_NUM];
    assign pred_bitmap  = latched_input_regs[(`DICE_GPR_NUM+`DICE_CR_NUM+`DICE_PR_NUM)-1:`DICE_GPR_NUM+`DICE_CR_NUM];
