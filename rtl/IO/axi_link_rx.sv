module axi_link_rx
  ...
  (input  logic                     clk_i
   ...
   ,output logic                    aruser_is_meta_o
   ,output logic [11:0]             aruser_o
  ...
  //               {aruser_is_meta_o, aruser_o} mirrors the header.
  ...
  assign aruser_is_meta_o = rd_desc_cast.is_meta;
  assign aruser_o  = rd_desc_cast.payload;
